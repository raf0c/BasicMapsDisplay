package com.example.raf0c.basicmapsdisplay.fragments;
...
public class NavigationDrawerFragment extends Fragment {
    ...
    public ListView mDrawerResultsList;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        menuIcons.recycle();
        adapter = new PlacesListAdapter(getActionBar().getThemedContext(), rowItems);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mDrawerResultsList = (ListView) myLayout.findViewById(R.id.results);
